# temp_model.py
# Trains a temperature prediction model using corrected historical weather data
# Saves temp_model.pkl for use in solar_predict_tool.py
...
MODEL_FILE   = r'C:\Users\Mumtaz Aysha\Documents\UNI HUB\Research-project\data\bronze\weather_data\temp_model.pkl'
...
def load_data():
    ...
    print(f'  T_corrected range: {df[TARGET].min():.2f} – {df[TARGET].max():.2f} °C')
    return df
...
def train_model(df):
    ...
    print(f'  Linear Regression     : R²={r2_lr}  MAE={mae_lr}°C')
    ...
    print(f'  Polynomial (deg 2)    : R²={r2_poly}  MAE={mae_poly}°C')
    ...
    print(f'  Random Forest         : R²={r2_rf}  MAE={mae_rf}°C')
    ...
    print(f'  Gradient Boosting     : R²={r2_gb}  MAE={mae_gb}°C')
